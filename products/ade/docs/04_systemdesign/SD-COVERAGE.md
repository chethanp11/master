...
|--------------|------------------|-------------------------|--------|
| AGENT-GEN-001 | `products/ade/docs/02_techspec/AGENT-agents.md#AGENT-GEN-001` | `products/ade/docs/04_systemdesign/agents-and-tools.md#agents` | Covered |
| AGENT-GEN-002 | `products/ade/docs/02_techspec/AGENT-agents.md#AGENT-GEN-002` | `products/ade/docs/04_systemdesign/agents-and-tools.md#agents` | Covered |
| AGENT-GEN-003 | `products/ade/docs/02_techspec/AGENT-agents.md#AGENT-GEN-003` | `products/ade/docs/04_systemdesign/agents-and-tools.md#agents` | Covered |
| AGENT-INTENT-001 | `products/ade/docs/02_techspec/AGENT-agents.md#AGENT-INTENT-001` | `products/ade/docs/04_systemdesign/agents-and-tools.md#agents` | Covered |
| AGENT-INTENT-002 | `products/ade/docs/02_techspec/AGENT-agents.md#AGENT-INTENT-002` | `products/ade/docs/04_systemdesign/agents-and-tools.md#agents` | Covered |
| AGENT-INTENT-003 | `products/ade/docs/02_techspec/AGENT-agents.md#AGENT-INTENT-003` | `products/ade/docs/04_systemdesign/agents-and-tools.md#agents` | Covered |
| AGENT-INTENT-004 | `products/ade/docs/02_techspec/AGENT-agents.md#AGENT-INTENT-004` | `products/ade/docs/04_systemdesign/agents-and-tools.md#agents` | Covered |
| AGENT-PLAN-001 | `products/ade/docs/02_techspec/AGENT-agents.md#AGENT-PLAN-001` | `products/ade/docs/04_systemdesign/agents-and-tools.md#agents` | Covered |
| AGENT-PLAN-002 | `products/ade/docs/02_techspec/AGENT-agents.md#AGENT-PLAN-002` | `products/ade/docs/04_systemdesign/agents-and-tools.md#agents` | Covered |
| AGENT-PROPOSAL-001 | `products/ade/docs/02_techspec/AGENT-agents.md#AGENT-PROPOSAL-001` | `products/ade/docs/04_systemdesign/agents-and-tools.md#agents` | Covered |
| AGENT-PROPOSAL-002 | `products/ade/docs/02_techspec/AGENT-agents.md#AGENT-PROPOSAL-002` | `products/ade/docs/04_systemdesign/agents-and-tools.md#agents` | Covered |
| AGENT-PROPOSAL-003 | `products/ade/docs/02_techspec/AGENT-agents.md#AGENT-PROPOSAL-003` | `products/ade/docs/04_systemdesign/agents-and-tools.md#agents` | Covered |
| AGENT-PLANNING-001 | `products/ade/docs/02_techspec/AGENT-agents.md#AGENT-PLANNING-001` | `products/ade/docs/04_systemdesign/agents-and-tools.md#agents` | Covered |
| AGENT-PLANNING-002 | `products/ade/docs/02_techspec/AGENT-agents.md#AGENT-PLANNING-002` | `products/ade/docs/04_systemdesign/agents-and-tools.md#agents` | Covered |
| AGENT-SUFF-001 | `products/ade/docs/02_techspec/AGENT-agents.md#AGENT-SUFF-001` | `products/ade/docs/04_systemdesign/agents-and-tools.md#agents` | Covered |
| AGENT-SUFF-002 | `products/ade/docs/02_techspec/AGENT-agents.md#AGENT-SUFF-002` | `products/ade/docs/04_systemdesign/agents-and-tools.md#agents` | Covered |
| AGENT-SUFF-003 | `products/ade/docs/02_techspec/AGENT-agents.md#AGENT-SUFF-003` | `products/ade/docs/04_systemdesign/agents-and-tools.md#agents` | Covered |
...
| GAP-016 | BRD-DAB-003..005 | Partial | Advisory labeling exists but no explicit prevention of downstream actions | Decision boundary remains implicit. | Code extension required |
| GAP-017 | BRD-ALIGN-001..002 | Clarification Needed | Framework alignment invariants not described | Prevents product re-implementation of core primitives. | Clarification required before build |
