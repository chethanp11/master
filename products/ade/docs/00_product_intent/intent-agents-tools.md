...
| **INT-NARR-005** | User-facing explanations SHALL be derived from platform decision records, not regenerated narratives | Preserve decision provenance | — | — | V1.2, 2026-01-18 |
...
| **INT-CONF-005** | ADE SHALL respect platform-defined confidence thresholds and gates when requesting execution, escalation, or human input | Align product gating with platform policy | — | — | V1.2, 2026-01-18 |
