...
| IMP-002 | BRD-AGT-001..004 | Enforce advisory-only agents and schema validation | Not completed (blocked) | None | None | None | MISSING |
...
| IMP-009 | BRD-DET-005 | Enforce static flow loading | Not completed (blocked) | None | None | None | MISSING |
| IMP-010 | BRD-TERM-001..004, BRD-STOP-001..002 | Terminal outcomes + safe exits | Not completed (blocked) | None | None | None | MISSING |
...
| GAP-IMP-002 | Implementation Missing / Partial | High | IMP-002 | BRD-AGT-001..004 | Advisory boundary and schema enforcement not implemented (core dependency). | `products/ade/docs/03_implementation_plan/imp_plan.md#imp-002` | Escalate to framework owner or allow core changes. |
...
| GAP-IMP-007 | Implementation Missing / Partial | High | IMP-009 | BRD-DET-005 | No explicit enforcement of static flow mutation in product scope. | `products/ade/docs/03_implementation_plan/imp_plan.md#imp-009` | Implement in core flow loader or document as framework responsibility. |
| GAP-IMP-008 | Implementation Missing / Partial | High | IMP-010 | BRD-TERM-001..004, BRD-STOP-001..002 | Terminal outcomes and safe exits not implemented. | `products/ade/docs/03_implementation_plan/imp_plan.md#imp-010` | Add outcome fields and gating in core engine. |
...
- Resolve GAP-IMP-002 by deciding whether core changes are allowed or documenting a framework dependency.
- Close GAP-IMP-008 by defining terminal outcomes and safe exit handling in orchestration.
